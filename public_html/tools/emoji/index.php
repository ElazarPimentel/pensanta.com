...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebApplication",
        "name": "Buscador de Emojis Gratis",
        "alternateName": "Emoji Picker",
        "description": "Encuentra y copia emojis al instante. 1876 emojis organizados por categorías. Buscador de emojis rápido y fácil. 100% gratis sin registro.",
        "url": "https://pensanta.com/tools/emoji/",
...
<body>
    ...
    <header class="container-main border-01" role="banner">
        <div id="header-container">
            ...
            <nav class="language-switcher" role="navigation" aria-label="Selector de idioma">
                <a href="/tools/emoji/index-eng.php" class="lang-button" lang="en" aria-label="Cambiar a inglés">EN</a>
            </nav>
        </div>
    </header>
    ...
    <script>
        ...
        function renderCategories() {
            ...
            const allBtn = `<button class="category-btn ${activeCategory === null ? 'active' : ''}" onclick="filterByCategory(null)">Todos</button>`;
        ...
        function renderRecentlyUsed() {
            ...
            grid.innerHTML = recentlyUsed.map(char =>
                `<button class="emoji-btn" onclick="copyEmoji('${char}')" title="Copiar ${char}">${char}</button>`
            ).join('');
        }
        ...
        function renderEmojis() {
            ...
            if (pageEmojis.length === 0) {
                grid.innerHTML = '<div class="no-results">No se encontraron emojis. Probá con otras palabras clave.</div>';
            } else {
        ...
        function updatePagination() {
            ...
            document.getElementById('pageInfo').textContent =
                totalPages === 0 ? '0 emojis' : `Página ${currentPage} de ${totalPages} (${filteredEmojis.length} emojis)`;
        }
